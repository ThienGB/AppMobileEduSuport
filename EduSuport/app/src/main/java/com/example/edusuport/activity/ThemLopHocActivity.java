...
public class ThemLopHocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnXacNhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String idGV = "1"; // gán id_GV từ việc login-home ?
                ...
                if ( tenLop.isEmpty()) {
                    ...
                    lopHoc.setIdGiaoVien(idGV);
                    lopHoc.setTenLopHoc(tenLop);

                    // Kiểm tra xem tên lớp đã tồn tại trong Firebase hay chưa
    ...
    public void BackLopHoc(){
        Intent intent = new Intent(ThemLopHocActivity.this, DanhSachLopHoc.class);
